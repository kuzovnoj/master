...
CSRF_TRUSTED_ORIGINS = [env("CSRF_TRUSTED_ORIGINS"),] #needed for Https
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Kuzov API", # название проекта
...
WSGI_APPLICATION = 'kuzmaster.wsgi.application'
